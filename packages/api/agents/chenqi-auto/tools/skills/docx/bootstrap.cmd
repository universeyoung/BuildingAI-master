@echo off
REM Bootstrap docx skill dependencies on Windows (cmd.exe).
REM
REM Mirrors bootstrap.sh: idempotent, fingerprint-based skip,
REM cleans node_modules when fingerprint changes (handles native ABI mismatch).
REM
...
set STAMP_FILE=%STAMP_DIR%\docx-bootstrap.stamp
...
call node -e "require('docx');console.log('[bootstrap] all deps require() OK');"
if errorlevel 1 exit /b 1
